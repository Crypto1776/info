...
const Informacion = () => {
  ...
  const informationDisplay = informationArray.map((info) => {
    return (
      <section className='information-row mb-14 px-5 md:px-20 gap-10 items-center'>
  ...
  return (
    <>
      <h2 className='text-2xl md:text-3xl lg:text-4xl text-center md:py-7 font-extrabold'>Información</h2>
